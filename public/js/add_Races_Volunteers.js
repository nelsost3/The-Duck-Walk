...
let addRaces_VolunteersForm = document.getElementById('add-Races_Volunteers-form-ajax');

// Modify the objects we need 
addRaces_VolunteersForm.addEventListener("submit", function (e) {
    ...
    let inputVolunteerID = document.getElementById('input-volunteer_id')

    // Get the values from the form fields
    let raceidValue = inputRaceID.value;
    let volunteerIDValue = inputVolunteerID.value

    // Put our data we want to send in a javascript object 
    let data = {
        race_id: raceidValue,
        volunteer_id: volunteerIDValue
    }

    // Setup our AJAX request 
    var xhttp = new XMLHttpRequest();
    xhttp.open("POST", "/add-Races_Volunteers-ajax", true);
...
addRowToTable = (data) => {
    ...
    let currentTable = document.getElementById('Races_Volunteers-table');
    ...
    deleteCell.onclick = function() {
        deleteRaces_Volunteers(newRow.assignment_id);
    };
